...
contract SimpleLending {
    ...
    /**
    And when you try to borrow or withdraw collateral, 
    the contract uses this mapping to check whether your position is still safe.
    To take a loan, you need to lock up collateral. 
    This mapping keeps track of how much ETH each user has provided as collateral.
    */
    ...
    function withdrawCollateral(uint256 amount) external {
        ...
        // Calculate how much collateral can be withdraw
