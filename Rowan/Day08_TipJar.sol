...
contract TipJar {
    ...
    //'public' will generate getter for each;
    ...
    //with onlyOwner() modifier, only the contract owner can call this function to add or update supported currencies and their conversion rates. This allows the owner to manage which currencies can be used for tipping and ensure that the conversion rates are accurate.
    ...
    //record every currency get how much for each
