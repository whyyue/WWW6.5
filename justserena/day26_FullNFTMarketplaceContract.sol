...
contract NFTMarketplace is ReentrancyGuard {
    address public owner;// 谁是这个交换站的大老板？
    uint256 public marketplaceFeePercent; // in basis points (100 = 1%)每卖出一个玩具，机器人要收多少“小费”当作手续费？
    address public feeRecipient;// 收到的“小费”最后存进哪个存钱罐？
