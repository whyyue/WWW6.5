...
contract MockWeatherOracle is AggregatorV3Interface, Ownable {
    ...
    uint80 private _roundId;//报告的序号
    uint256 private _timestamp;//下雨的时间
    uint256 private _lastUpdateBlock;

    constructor() Ownable(msg.sender) {
        _decimals = 0; // Rainfall in whole millimeters 只记录整数
    ...
    function _rainfall() public view returns (int256) {
        ...
        uint256 blocksSinceLastUpdate = block.number - _lastUpdateBlock;//距离上次更新过去了多久
