...
function enter()public payable{
    require (
        lotteryState==LOTTERY_STATE.OPEN,"Lottry not open"
    );
...
function startLottery()external onlyOwner{
    require (lotteryState == LOTTERY_STATE.CLOSED,"CANT START YET");
...
VRFV2PlusClient.RandomWordsRequest memory req = VRFV2PlusClient.RandomWordsRequest({  keyHash: keyHash,
