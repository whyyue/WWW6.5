...
contract EventEntry {
    string public eventName; //活动内容
    address public organizer; //谁负责
    uint256 public eventDate; //何时发生
    uint256 public maxAttendees; //可参加人数
    uint256 public attendeeCount;//签到人数
    bool public isEventActive; //是否还可参与

    mapping(address => bool) public hasAttended; //考勤跟踪——映射签到的人
