...
contract NFTMarketplace is ReentrancyGuard {
    ...
    address public feeRecipient;//收手续费的人
    ...
    struct Listing {
        ...
        uint256 price;
        address royaltyReceiver;// 原创作者（赚版税）
        uint256 royaltyPercent; //作者抽成比例 以基点为单位
    ...
    function listNFT(
        ...
        require(!listings[nftAddress][tokenId].isListed, "Already listed");//已经上架了
