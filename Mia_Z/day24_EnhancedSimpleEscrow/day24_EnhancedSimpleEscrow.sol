...
contract EnhancedSimpleEscrow {
    ...
    // Using `call` avoids Solidity's `transfer` deprecation warnings.
    // State is updated before any external call to reduce reentrancy risk.
    ...
    function resolveDispute(bool _releaseToSeller) external {
        ...
        if (_releaseToSeller) {
            ...
            _safeTransfer(payable(buyer), amount);
    ...
    function cancelAfterTimeout() external {
        ...
        _safeTransfer(payable(buyer), address(this).balance);
