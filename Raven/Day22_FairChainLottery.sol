...
contract FairChainLottery is VRFConsumerBaseV2Plus {
	...
	function endLottery() external onlyOwner {
		...
		// build a RandomWordsRequest object
		...
		// Send request to coordinator and receive a request ID
		latestRequestId = s_vrfCoordinator.requestRandomWords(req);
	}
	// Callback function will be called automatically
	// Got randomWords array
