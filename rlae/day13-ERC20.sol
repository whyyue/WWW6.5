...
contract SimpleERC20 {
    ...
    function transfer(address _to, uint256 _value) public virtual returns(bool){ //逻辑分离 // virtual 如果有其他合约继承了这个合约，这个函数是可以被重新修改的
    ...
    function transferFrom(address _from, address _to, uint256 _value) public virtual returns(bool){ //virtual
