...
contract GasEfficientVoting {
    ...
    function createProposal(bytes32 name, uint32 duration) external onlyOwner {
        require(duration > 0, "Duration must be > 0");
        require(proposalCount < 255, "Max proposals reached"); 
    ...
    function executeProposal(uint8 proposalId) external onlyOwner {
        require(proposalId < proposalCount, "Invalid proposal");
