...
contract YieldFarming is ReentrancyGuard {
    ...
    uint256 public rewardRatePerSecond; // 每秒分配的奖励（奖励速率的单位是每秒每ETH奖励多少Wei，所以下面计算pendingReward(Wei)时需要/rewardMultiplier把stakedAmount从Wei转化为ETH）
    ...
    function stake(uint256 amount) external nonReentrant {
        ...
        // 确保**公平的奖励跟踪** — 新存款不会抹去或搞乱先前的奖励。奖励必须在更改质押金额*之前*计算。
        // 必须先更新rewardDebt和lastUpdate，因为从此stakedAmount（奖励计算基数）变了。
